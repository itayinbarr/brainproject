...
const ICONS = {
  ...
  headset: '<path d="M4 9.5A2.5 2.5 0 0 1 6.5 7h11A2.5 2.5 0 0 1 20 9.5v3.5a2 2 0 0 1-2 2h-2.4a1.6 1.6 0 0 1-1.3-.66l-.9-1.2a1.8 1.8 0 0 0-2.8 0l-.9 1.2A1.6 1.6 0 0 1 8.4 15H6a2 2 0 0 1-2-2Z"/>',
};
